...
# 🎮 JunkTok: Paranormal Investigators Challenge — Community Edition

**Stream haunts, hunt ghosts, chase clout in JunkTok.**
...
JunkTok: Paranormal Investigators Challenge is a first-person horror simulation game where players take on the role of amateur ghost hunters who investigate haunted locations while streaming their findings to an in-game audience. This Community Edition is a standalone build delivered as a self-contained package, ready to play immediately with no storefront required. The offline version includes all content from the base game and does not require any additional software to run.

This standalone Community Edition is intended for players who want a self-contained offline version of JunkTok: Paranormal Investigators Challenge on Windows PC.
...
<table>
 ...
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2276810/c9f4df5104f0a74d033f0174a197d0a4544fe997/ss_c9f4df5104f0a74d033f0174a197d0a4544fe997.1920x1080.jpg?t=1788192782" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2276810/7bfd2c99ba72e63b009e3a34919c84a9afba91dd/ss_7bfd2c99ba72e63b009e3a34919c84a9afba91dd.1920x1080.jpg?t=1788192782" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 👻 **Paranormal Investigation** — Explore haunted sites and gather evidence of supernatural activity using a range of ghost-hunting tools.
- 📱 **In-Game Streaming** — Record and stream your investigations to a fictional social platform where viewers react in real time.
- 🎥 **First-Person Horror** — Experience atmospheric, tension-driven horror from an immersive first-person perspective.
- 🛠️ **Equipment Management** — Purchase, upgrade, and deploy gadgets like EMF readers, spirit boxes, and night-vision cameras.
- 🤝 **Cooperative Play** — LAN or direct connection supported for investigating haunted locations with friends.
- 🗺️ **Multiple Haunted Maps** — Investigate a variety of procedurally varied locations, from abandoned houses to derelict factories.
- 📈 **Follower Progression** — Grow your in-game audience and enable better gear as your paranormal channel gains popularity.
- 💾 **Standalone Package** — Self-contained build with all content included; no storefront or additional software required.
- 🌐 **Offline Support** — Full single-player experience playable entirely offline.
- 🎚️ **Configurable Difficulty** — Adjust ghost behavior, sanity effects, and equipment costs to suit your playstyle.
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 570 (4 GB VRAM) | NVIDIA GeForce RTX 2060 / AMD Radeon RX 5600 XT (6 GB VRAM) |
| **Storage** | 12 GB available space | 12 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | VR headset optional for supported features |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\JunkTok:ParanormalInvestigatorsChallenge\Saved`
